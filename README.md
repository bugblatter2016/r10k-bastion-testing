...
1. [Setup - The basics of getting started with bastion](#setup)
    * [What bastion affects](#what-bastion-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with bastion](#beginning-with-bastion)
